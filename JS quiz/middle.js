const DATA = [
    ...
    {
        level: 'Middle',
        question: 'Olympus is a huge mountain of volcanic origin. What planet is she on?',
        answers: [
            {
                id: '83',
                value: 'Mars',
    ...
    {
        level: 'Middle',
        question: 'Which planet in the solar system has recently been demoted to a dwarf planet by the International Astronomical Union?',
        answers: [
            {
                id: '92',
                value: 'Neptune',
